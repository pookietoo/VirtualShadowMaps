...
struct Light
{
	...
	uint vsmShadowIndex;  // VSM PATCH (light-index alignment): was 'uint pad0' — reused (no layout change). VSM's ShadowLights slot (0xFFFFFFFF = no VSM shadow). Must match C++ LightData. See notes/CS_INTEGRATION_MANIFEST.md P4.
	uint pad1;
};
